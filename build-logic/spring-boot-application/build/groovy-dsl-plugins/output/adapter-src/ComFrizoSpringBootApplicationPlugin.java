...
/**
 * Precompiled com.frizo.spring-boot-application script plugin.
 **/
public class ComFrizoSpringBootApplicationPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComFrizoSpringBootApplication").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.frizo.commons");
            target.getPluginManager().apply("org.springframework.boot");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComFrizoSpringBootApplication").asSubclass(BasicScript.class);
